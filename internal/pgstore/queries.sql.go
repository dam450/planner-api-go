...
const inviteParticipantToTrip = `-- name: InviteParticipantToTrip :exec
...
func (q *Queries) InviteParticipantToTrip(ctx context.Context, arg InviteParticipantToTripParams) error {
	_, err := q.db.Exec(ctx, inviteParticipantToTrip, arg.TripID, arg.Email)
	return err
}
